...
(define state_createheap
  (lambda (state)
    (state_update_impl 'super '(1) (state_declare_impl 'super state))))
...
; Test case: (ptr_dereference (heap_add_resultstate (state_createheap '(())) 'a) 1)
;         -> 'a
; Test case: (ptr_dereference (heap_add_resultstate (heap_add_resultstate (state_createheap '(())) 'a) 'b) 1)
;         -> 'a
